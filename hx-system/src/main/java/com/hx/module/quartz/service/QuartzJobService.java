package com.hx.module.quartz.service;
...
public interface QuartzJobService {
     ...
     * @return /
     */
    Object queryAll(QuartzJobQuery criteria, Pageable pageable);
     ...
     * @return /
     */
    List<QuartzJob> queryAll(QuartzJobQuery criteria);
     ...
     * @return /
     */
    Object queryAllLog(QuartzJobQuery criteria, Pageable pageable);
     ...
     * @return /
     */
    List<QuartzLog> queryAllLog(QuartzJobQuery criteria);
