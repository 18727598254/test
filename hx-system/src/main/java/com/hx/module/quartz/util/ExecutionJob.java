package com.hx.module.quartz.util;

import cn.hutool.extra.template.Template;
import cn.hutool.extra.template.TemplateConfig;
import cn.hutool.extra.template.TemplateEngine;
import cn.hutool.extra.template.TemplateUtil;
import com.hx.domain.vo.EmailVo;
...
import com.hx.service.EmailService;
import com.hx.thread.ThreadPoolExecutorUtil;
import com.hx.util.RedisUtils;
import com.hx.util.SpringContextHolder;
import com.hx.util.StringUtils;
import com.hx.util.ThrowableUtil;
...
public class ExecutionJob extends QuartzJobBean {
    ...
    public void executeInternal(JobExecutionContext context) {
        ...
        // 获取spring bean
        QuartzLogDao quartzLogRepository = SpringContextHolder.getBean(QuartzLogDao.class);
